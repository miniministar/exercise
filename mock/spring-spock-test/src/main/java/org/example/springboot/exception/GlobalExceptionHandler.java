...
public class GlobalExceptionHandler {
     ...
     * 表单参数校验异常：MethodArgumentNotValidException
     */
    ...
    public <T> Result<T> processException(BindException e) {
        ...
        return Result.failed(ResultCode.PARAM_ERROR, (T) msg);
    }
    ...
    public <T> Result<T> handleClientAbortException(ClientAbortException e) {
        log.error("客户端请求取消异常，异常原因：{}", e.getMessage(), e);
        return Result.failed(e.getMessage());
    }
